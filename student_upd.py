...
class Student:
    def __init__(self,root):
        ...
        # self.slider()
        # self.heading_color()
        lbl_main = Label(text="Quản lý thông tin sinh viên", font=("times new roman", 26,"bold"),bg="white", fg="red")
        ...
        label_Update_att.place(x=0, y=1, width=600, height=32)


        #course
        current_course_frame = LabelFrame(Left_frame, bd=2, bg="white", relief=RIDGE, text="Thông tin khoá học",
                                font=("times new roman", 12, "bold"))
        current_course_frame.place(x=5, y=27, width=580, height=120)
        ...
        course_combo = ttk.Combobox(current_course_frame,textvariable=self.var_course, font=("times new roman", 13, "bold"), state="readonly",width=15)
        ...
        class_student_frame.place(x=5, y=160, width=580, height=420)
        ...
        studentID_entry=ttk.Entry(class_student_frame,width=15,textvariable=self.var_std_id,font=("times new roman", 13, "bold"),state="disabled")
        ...
        studentName_entry = ttk.Entry(class_student_frame, width=15,textvariable=self.var_std_name, font=("times new roman", 13, "bold"))
        ...
        class_div_entry = ttk.Entry(class_student_frame, width=15,textvariable=self.var_div, font=("times new roman", 13, "bold"))
        ...
        roll_no_entry = ttk.Entry(class_student_frame, width=15,textvariable=self.var_roll ,font=("times new roman", 13, "bold"))
        ...
        self.dob_entry = DateEntry(class_student_frame, width=13, bd=3,selectmode='day',
        ...
        address_entry = ttk.Entry(class_student_frame, width=15,textvariable=self.var_address ,font=("times new roman", 13, "bold"))
        ...
        btn_frame.place(x=5,y=260,width=560,height=35)

        save_btn=Button(btn_frame,text="Lưu",command=self.add_data,font=("times new roman",13,"bold"),bg="#38a6f0", fg="white",width=13)
        save_btn.grid(row=0,column=0)

        update_btn = Button(btn_frame, text="Sửa",command=self.update_data, font=("times new roman", 13, "bold"), bg="#38a6f0", fg="white", width=13)
        update_btn.grid(row=0, column=1)

        delete_btn = Button(btn_frame, text="Xóa",command=self.delete_data, font=("times new roman", 13, "bold"), bg="#38a6f0", fg="white", width=13)
        delete_btn.grid(row=0, column=2)

        reset_btn = Button(btn_frame, text="Làm mới",command=self.reset_data, font=("times new roman", 13, "bold"), bg="#38a6f0", fg="white", width=13)
        reset_btn.grid(row=0, column=3)

        btn_frame1 = Frame(class_student_frame, bd=2, relief=RIDGE, bg="white")
        btn_frame1.place(x=5, y=300, width=560, height=35)
        ...
        Right_frame = LabelFrame(main_frame, bd=2, bg="white",
                                font=("times new roman", 12, "bold"))
        Right_frame.place(x=620, y=10, width=610, height=550)


        #Search_frame
        search_frame = LabelFrame(Right_frame, bd=2, bg="white", relief=RIDGE, text="Hệ Thống Tìm kiếm",
                                         font=("yu gothic ui", 13, "bold"))
        search_frame.place(x=5, y=5, width=595, height=70)
        ...
        search_entry = ttk.Entry(search_frame, width=10, font=("times new roman", 13, "bold"),textvariable=self.var_search)
        search_entry.grid(row=0, column=2, padx=10, pady=5, sticky=W)

        search_btn = Button(search_frame, text="Tìm kiếm", font=("times new roman", 12, "bold"),bg="#38a6f0", fg="white", width=10,command=self.search_data)
        ...
        Underright_frame.place(x=625, y=300, width=600, height=310)
        ...
        searchstd_entry = ttk.Entry(Underright_frame, textvariable=self.var_searchclass, width=10,
