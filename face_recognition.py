...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        choose_type_att=Label(self.choose_frame, text="Chọn loại Điểm Danh: ", font=("times new roman", 12, "bold"),
                             bg="white")
        choose_type_att.grid(row=0, column=2, padx=10, pady=10, sticky=W)
        ...
        img_btn1 = img_btn1.resize((350, 45), PIL.Image.Resampling.LANCZOS)
        ...
        self.btnOpen.place(x=120, y=580, width=250, height=45)
        if self.selectsub.get()=="":
            self.btnOpen['state'] = "disabled"

        img_btn2 = PIL.Image.open(r"ImageFaceDetect\btnClose.png")
        img_btn2 = img_btn2.resize((350, 45), PIL.Image.Resampling.LANCZOS)
        ...
        self.btnClose.place(x=400, y=580, width=200, height=45)


        #Right_frame
        self.Right_frame = LabelFrame(self.root, bd=2, bg="white", relief=RIDGE, text="Điểm danh thành công",
                                font=("times new roman", 12, "bold"))
        self.Right_frame.place(x=750, y=70, width=450, height=300)
        ...
        self.studentID_atten_info=Label(self.Right_frame, bg="white",
                                font=("times new roman", 12, "bold"))
        self.studentID_atten_info.place(x=5,y=120,width=400,height=200)
        ...
        self.RightU_frame = LabelFrame(self.root, bd=2, bg="white", relief=RIDGE, text="Thông tin buổi học",
                                      font=("times new roman", 12, "bold"))
        self.RightU_frame.place(x=750, y=400, width=450, height=220)
