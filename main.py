...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        img_peop = img_peop.resize((27, 27), PIL.Image.Resampling.LANCZOS)
        ...
        img_logout = img_logout.resize((27, 27), PIL.Image.Resampling.LANCZOS)
        ...
        img_btn1 = img_btn1.resize((80, 80), PIL.Image.Resampling.LANCZOS)
        ...
        b2.place(x=160, y=410, width=130, height=130)

        #============student================
        img_btn2 = PIL.Image.open(r"ImageFaceDetect\student.png")
        img_btn2 = img_btn2.resize((80, 80), PIL.Image.Resampling.LANCZOS)
        ...
        btn2 = Button(self.root, text="Sinh viên", font=("yu gothic ui", 16, "bold"),command=self.student_details, image=self.photobtn2,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        btn2.place(x=170, y=170, width=130, height=130)

        #============nhan dien============
        img_btn3 = PIL.Image.open(r"ImageFaceDetect\nhandien.png")
        img_btn3 = img_btn3.resize((80, 80), PIL.Image.Resampling.LANCZOS)
        ...
        b3 = Button(self.root, text="Nhận diện", font=("yu gothic ui", 16, "bold"),command=self.face_recognition ,image=self.photobtn3,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b3.place(x=450, y=170, width=130, height=130)

        #===========diem-danh===============
        img_btn4 = PIL.Image.open(r"ImageFaceDetect\ghichu.png")
        img_btn4 = img_btn4.resize((80, 80), PIL.Image.Resampling.LANCZOS)
        ...
        b4 = Button(self.root, text="Điểm danh", font=("yu gothic ui", 16, "bold"),command=self.attendance_data ,image=self.photobtn4,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b4.place(x=740, y=170, width=130, height=130)

        #==========monhoc=================
        img_btn5 = PIL.Image.open(r"ImageFaceDetect\book.png")
        img_btn5 = img_btn5.resize((80, 80), PIL.Image.Resampling.LANCZOS)
        ...
        b7 = Button(self.root, text="Buổi học", font=("yu gothic ui", 16, "bold"),command=self.lesson_data, image=self.photobtn7,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b7.place(x=740, y=410, width=130, height=130)

        #==========XemAnh===============
        img_btn8 = PIL.Image.open(r"ImageFaceDetect\picture.png")
        img_btn8 = img_btn8.resize((80, 80), PIL.Image.Resampling.LANCZOS)
